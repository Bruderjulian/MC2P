...
public final class WriteTools {
    ...
    public static final Set<String> SAFE_BLOCK_MATERIALS = Set.of(
            ...
            "glass", "glass_pane", "bricks", "stone_bricks", "mossy_stone_bricks",
            "cobblestone_wall", "oak_fence", "oak_fence_gate", "oak_door", "oak_trapdoor",
            "oak_stairs", "stone_slab", "oak_slab",
            "torch", "lantern", "sea_lantern", "glowstone",
            "wheat", "wheat_seeds", "carrots", "potatoes",
            "water", "lava", "ice", "packed_ice", "snow_block", "snow",
            "moss_block", "azalea", "flowering_azalea",
            "pumpkin", "melon", "sweet_berry_bush",
            ...
            "redstone_lamp", "lightning_rod", "note_block", "jukebox",
            "candle", "chain", "ladder", "scaffolding", "tnt" /* unignited only; set requires confirm + admin */);
    ...
    public static void register(ToolRegistry registry, ServerFacade facade, BackendConfig config) {
        ...
        CommandPolicy commandPolicy = new CommandPolicy(config.commands().opsAllowlist(),
                config.commands().adminAllowlist(), config.commands().deny(), limits.maxCommandLength());

        registry.register(new ToolSpec("player_message", Role.OPS, false, false,
        ...
        registry.register(new ToolSpec("player_kick", Role.OPS, true, true,
        ...
        registry.register(new ToolSpec("player_teleport", Role.OPS, false, false,
                ...
                (args, auth) -> {
                    ...
                    if (target == null) {
                        ...
                        if (!Validators.isWithinCoordinate(x, max) || !Validators.isWithinCoordinate(y, max)
        ...
        registry.register(new ToolSpec("player_gamemode", Role.OPS, false, false,
        ...
        registry.register(new ToolSpec("player_effect", Role.OPS, false, false,
                ...
                (args, auth) -> {
                    ...
                    return Map.of("serverId", facade.serverId(), "effect", effect, "durationSeconds", duration,
                            "amplifier", amplifier);
                }));

        registry.register(new ToolSpec("player_ban", Role.ADMIN, true, true,
        ...
        registry.register(new ToolSpec("player_unban", Role.ADMIN, true, true,
        ...
        registry.register(new ToolSpec("player_whitelist_add", Role.ADMIN, false, false,
        ...
        registry.register(new ToolSpec("player_whitelist_remove", Role.ADMIN, true, true,
        ...
        registry.register(new ToolSpec("command_execute", Role.OPS, true, true,
        ...
        if (config.features().blockEdit()) {
            registry.register(new ToolSpec("block_set", Role.ADMIN, true, true,
        ...
        registry.register(new ToolSpec("server_restart", Role.ADMIN, true, true,
                ...
                (args, auth) -> {
                    if (!facade.restartAvailable()) {
                        throw new ToolException("restart is not available on this host: "
        ...
        registry.register(new ToolSpec("server_stop", Role.ADMIN, true, true,
