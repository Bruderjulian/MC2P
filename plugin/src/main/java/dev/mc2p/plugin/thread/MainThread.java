...
public final class MainThread {
    ...
    public MainThread(Plugin plugin, long timeoutMillis) {
        this.plugin = plugin;
        this.timeoutMillis = timeoutMillis;
    }

    /**
     * Executes on the main thread, returning the result. The calling thread blocks up to
    ...
    /** Runs a fire-and-forget task on the main thread (notifications, announce broadcasts). */
