 ...
 * </ul>
 *
 * Only one of the two files exists on disk at a time; switching modes swaps them and
...
public record BackendConfig(
    ...
    public static BackendConfig load(Map<String, Object> yaml) {
        ...
        String serverId = ConfigSupport.str(yaml, "serverId", "main");
        ...
        RestrictionsConfig server = RestrictionsConfig.load(ConfigSupport.map(yaml.get("server-restrictions")));
